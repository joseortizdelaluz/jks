...
import { IClase } from '../models/producto.model';

@Injectable({providedIn: 'root'})
export class ProductoClaseService {
    private url: string = `${Const.url}/catalogos/productos/clases`;
    constructor(private http: HttpClient) { }

    public lista(): Observable<IClase[]>{
